        ...
        <div className="min-h-screen bg-gray-50 flex flex-col">
            ...
            <div className="flex flex-1">
                ...
                <main className="flex-1 min-w-0">
                    ...
                    <div className="bg-white/80 backdrop-blur border-b border-gray-200 px-3 py-3 md:px-8 md:py-5 sticky top-[0px] md:top-[76px] z-10 shadow-sm">
                        <div className="flex items-center justify-between">
                            <div>
                                <h1 className="text-lg md:text-2xl font-bold text-gray-900 tracking-tight">数据分析工作台</h1>
                                <p className="text-xs md:text-sm text-gray-500 mt-0.5 md:mt-1">深度挖掘产业用工效能，辅助精准决策</p>
                            </div>
                        </div>
                    </div>
